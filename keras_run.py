...
clean_data_first, valid_obs_first = reshape_and_clean_data(data_first, valid_obs_number=251)
clean_data_second, valid_obs_second = reshape_and_clean_data(data_second, valid_obs_number=251)
